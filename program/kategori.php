...
<div class="container">
    ...
    <!-- MODAL -->
           ...
           Tambah Kategori
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Form Kategori</h1>
                ...
                <div class="modal-body">
                        <div class="mb-3">
                            ...
                            $query = mysqli_query($koneksi, "SELECT max(kode_kategori) as kodeTerakhir FROM t_kategori");
                            ...
                            ?>
                         <input type="text" class="form-control" value="<?php echo $Kode ?>" name="tkodekategori" readonly>
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama Kategori</label>
                            <input type="text" class="form-control" name="tnamakategori" placeholder="Masukkan Nama Kategori">
                        </div>
                </div>
        ...
        <table class="table table-bordered table-striped table-hover">
            ...
            //menampilkan data
            $no = 1;
            $tampil = mysqli_query($koneksi, "SELECT * FROM t_kategori ORDER BY id_kategori DESC");
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                        <div class="mb-3">
                            <label class="form-label">Kode Kategori</label>
                            <input type="text" class="form-control" name="tkodekategori" value="<?= $data['kode_kategori'] ?>" 
                            placeholder="Masukkan Kode Kategori">
                        </div>
                        <div class="mb-3">
                            <label class="form-label">Nama Kategori</label>
                            <input type="text" class="form-control" name="tnamakategori" value="<?= $data['nama_kategori'] ?>" 
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-body">
                    ...
                    <h5 class="text-center"> Apakah anda yakin akan menghapus data ini <br>
                      <span class="text-danger"><?= $data['kode_kategori'] ?> - <?= $data['nama_kategori'] ?></span> 
                      </h5> 
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Keluar</button>
