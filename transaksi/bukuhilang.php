    ...
    <div class="container">
      <div class="card mt-3">
        <div class="card-header bg-primary text-white">
          <h2 class="text-center">Data Buku Hilang</h2>
          ...
          <div class="table-responsive">
            <table  class="display table table-bordered" id="transaksi">
              ...
              <tbody>
                <?php 
                  $no = 1;
                  $sql = $koneksi->query("select * from t_transaksi where status='Hilang'");
                ...
                <tr>
                  ...
                  <td>
                    <a href="gantirugi.php?id=<?php echo $data['id']; ?>&judul=<?php echo $data['judul']; ?>" class="btn btn-primary">Bayar</a>
                  </td>
                </tr>
									  <?php } ?>
              </tbody>
